...
badd +1 src/library/bcm/core/dispatchers/BcmDispatcher.class.php
badd +16 src/bcm/cliindex.php
badd +29 src/www/index.php
badd +1 src/library/bcm/modules/posts/ui/PostsDispatcher.class.php
badd +285 src/library/bcm/modules/posts/PostsActions.class.php
...
badd +170 /media/dev002/lm/bsalice/trunk/src/library/bsalice/modules/bi/BiActions.class.php
badd +1 /media/dev002/lm/bsalice/trunk/src/www/bsmobile.php
...
badd +1 src/library/bcm/modules/postsmedia/PostsmediaActions.class.php
badd +1 src/library/bcm/modules/postsmedia/PostsmediaFilter.class.php
badd +0 /media/dev002/lm/bsblogs/trunk/src/library/bsblogs/core/utils.php
badd +47 /media/dev002/lm/bzrvendors/hautetfort/trunk/classlib/smarty/plugins/prefilter.bannerhautetfort.php
badd +0 NERD_tree_9
args ~/.bash_local
...
774
normal! 044l
tabedit src/library/bcm/modules/activitiesboard/ActivitiesboardActions.class.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 217 - ((36 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
217
...
setlocal fen
silent! normal! zE
let s:l = 329 - ((0 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
329
normal! 0
tabedit src/library/bcm/modules/activitiesboard/ActivitiesboardFilter.class.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 206 - ((26 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
206
normal! 015l
tabedit /media/dev002/lm/bsalice/trunk/src/library/bsalice/modules/bi/BiActions.class.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 171 - ((26 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
171
normal! 037l
tabedit src/library/bcm/modules/posts/PostsActions.class.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 345 - ((23 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
345
normal! 012l
tabedit src/library/bcm/modules/postsmedia/PostsmediaFilter.class.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
79
normal! 04l
tabedit src/library/bcm/modules/postsmedia/PostsmediaActions.class.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 214 - ((0 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
214
normal! 0
tabedit src/library/bcm/modules/posts/ui/PostsDispatcher.class.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 77 - ((49 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
77
